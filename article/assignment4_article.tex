...
\\
One can observe from \figref{energyappearance} that the curves are slightly skewed towards the higher energy values. The curve is bell shaped and centred around the equilibrium state for the lattice at temperature $T = 2.4$ which is -$790$. 
